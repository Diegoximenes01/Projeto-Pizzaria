...
export default function Payment() {
  ...
  const [opcaoCartao, setOpcaoCartao] = useState('online');
  const [tipoCartao, setTipoCartao] = useState('crédito');
  const [localPagamento, setLocalPagamento] = useState('online');
