...
export default function Success() {
  ...
  return (
    <div style={{textAlign: 'center', padding: '60px 20px', maxWidth: 600, margin: '0 auto', background: '#000000', borderRadius: 12, border: '1px solid var(--border)'}}>
      <div style={{fontSize: 64, marginBottom: 16}}>✅</div>
      <h1 style={{color: '#2ecc71', marginBottom: 16}}>Pagamento Concluído com Sucesso!</h1>
      ...
      <div style={{margin: '32px 0', padding: 24, background: 'var(--input-bg)', borderRadius: 8, border: '1px solid var(--border)'}}>
        <h3 style={{marginBottom: 8, fontSize: 16, color: 'var(--text-muted)'}}>Tempo estimado para entrega/retirada:</h3>
        <span style={{fontSize: 24, fontWeight: 800, color: '#2ecc71'}}>{time}</span>
      </div>
